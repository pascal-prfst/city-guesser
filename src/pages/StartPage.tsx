  ...
  return (
    <section className={classes.startpage_container}>
      ...
      <div className={classes.rules_container}>
        <h2>Spielregeln:</h2>
        <p>
          Du siehst eine Karte von Europa. Über der Karte wird dir eine zufällige Stadt angezeigt,
          die du auf der Karte finden musst. Setze einfach per Klick einen Marker an der Stelle, wo
          du denkst dort ist die gesuchte Stadt. Bist du dir sicher den Marker richtig gesetzt zu
          haben klicke unten auf den Button "Platzieren". Bist du innerhalb eines Radius von 50km
